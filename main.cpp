...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	while (Novice::ProcessMessage() == 0)
	{
		...
		ImGui::Begin("Window");
		ImGui::SliderFloat3("Shoulder Translate", &translates[0].x, -1.0f, 1.0f);
		ImGui::SliderFloat3("Shoulder Rotate", &rotates[0].x, -(float)M_PI, (float)M_PI);
		ImGui::SliderFloat3("Elbow Translate", &translates[1].x, -1.0f, 1.0f);
		ImGui::SliderFloat3("Elbow Rotate", &rotates[1].x, -(float)M_PI, (float)M_PI);
		ImGui::SliderFloat3("Hand Translate", &translates[2].x, -1.0f, 1.0f);
		ImGui::SliderFloat3("Hand Rotate", &rotates[2].x, -(float)M_PI, (float)M_PI);
		ImGui::End();
		...
		Matrix4x4 shoulderMatrix = mathFunc.MakeAffineMatrix({ 1.0f, 1.0f, 1.0f }, rotates[0], translates[0]);
		Matrix4x4 elbowMatrix = mathFunc.MakeAffineMatrix({ 1.0f, 1.0f, 1.0f }, rotates[1], translates[1]);
		Matrix4x4 handMatrix = mathFunc.MakeAffineMatrix({ 1.0f, 1.0f, 1.0f }, rotates[2], translates[2]);
